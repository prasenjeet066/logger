          ...
          <div className="space-y-6 text-sm">
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                <p>
                  Zeeta প্ল্যাটফর্ম ব্যবহার করে আপনি এই শর্তাবলীতে সম্মত হচ্ছেন। আমাদের সেবা ব্যবহারের জন্য আপনাকে অবশ্যই ১৩ বছর বা তার
                  বেশি বয়সী হতে হবে।
                </p>
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p>Zeeta প্ল্যাটফর্মের সকল ট্রেডমার্ক, লোগো এবং ব্র্যান্ড নাম আমাদের সম্পত্তি।</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                <p>Zeeta "যেমন আছে" ভিত্তিতে সেবা প্রদান করে। আমরা সেবার নিরবচ্ছিন্নতা বা ত্রুটিমুক্ততার গ্যারান্টি দিই না।</p>
