// components/auth/steps/EmailStep.tsx
"use client"
...
// Validation function for EmailStep
export const validateEmailStep = (formData: any): Record<string, string> => {
