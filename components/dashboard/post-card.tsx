    ...
    return (
      ...
      {mediaUrls.slice(0, 4).map((url, index) => (
        <div key={index} className={`relative group ${isNsfw ? "backdrop-blur-lg flex flex-col items-center justify-center" : ""}`}>
          {isNsfw && (
            <>
              <div className="absolute inset-0 bg-black/10 flex flex-col items-center justify-center rounded z-10">
                <span className="font-semibold text-white text-center mb-2 text-md">18+</span>
                <button 
