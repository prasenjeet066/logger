      ...
      <div className="p-4 flex flex-col">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {isPostPage && ( // Only show translation on post detail page
              <div className="mb-3">
                <button
            ...
            <div className="flex items-center justify-between max-w-sm lg:max-w-md mt-3">
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation()
                  handleReplyClick() // Use the handleReplyClick for consistency
                }}
              ...
              <Button
                variant="ghost"
                size="sm"
                className={`${post.isReposted ? "text-green-600 bg-green-50" : "text-gray-500 hover:text-green-600 hover:bg-green-50"} p-2 rounded-full transition-colors`}
                onClick={(e) => {
                  e.stopPropagation()
                  handleRepostClick()
                }}
