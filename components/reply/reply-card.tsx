...
export function ReplyCard({ post, onLike, onRepost }: PostCardProps) {
  ...
  return (
    <main>
      ...
      <div className={replies.length ? "flex p-4 flex-col" : "flex p-4 pb-2 flex-col"}>
        ...
        <div className={`flex relative h-full flex-row ${replies.length ? 'p-4' : 'p-4 pb-1'} gap-2 pt-1`}>
          {replies.length ? (
